package com.lswq.zk.client.lock;
...
public class DistributedLock implements Lock {
    ...
    private static final String ZOOKEEPER_IP_PORT = "192.168.15.190:2181";
    ...
    public boolean tryLock() {
        ...
        //判断创建的子节点/LOCK/Node-n是否最小,即currentPath,如果当前节点等于children中的最小的一个就占用锁
    ...
    private void waitForLock() {
        IZkDataListener listener = new IZkDataListener() {
            public void handleDataDeleted(String dataPath) throws Exception {
                System.err.println(Thread.currentThread().getName() + ":捕获到DataDelete事件！---------------------------");
                if (cdl != null) {
                    cdl.countDown();
                }
            }
